...
const byAuthor = allApps
  .filter(app =>
    app.id !== entry.id &&
    app.data.authors.some(a => currentAuthors.includes(a.slug))
  )
  .slice(0, 4);
```
...
<div class="relative" data-search-wrapper>
  <input
    ...
    data-search-input
  />
  <div class="absolute top-full left-0 right-0 mt-2 bg-white dark:bg-secondary-800
...
const domainEnum = z.enum([
  'technology', 'space', 'defense', 'artificialIntelligence',
  'health', 'mentalHealth',
  'environment', 'agriculture', 'cleanEnergy',
  'education', 'research',
  'startups', 'finance', 'manufacturing',
  'socialImpact', 'governance', 'ruralDevelopment',
  'arts', 'music', 'cinema', 'literature', 'heritage',
  'sports', 'fitness',
  'infrastructure', 'transportation',
  'digitalIndia', 'cybersecurity', 'gaming',
]);
```
