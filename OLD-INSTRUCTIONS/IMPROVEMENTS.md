...
| [x]  | P2       | [7.3 Improve related content scoring](#73-improve-related-content-scoring)                                  | S      | Medium |
| [ ]  | P2       | [7.4 "By same author" sidebar section](#74-add-by-the-same-author-section-to-right-sidebar)                 | S      | Medium |
| [x]  | P3       | [1.4–1.6 Remaining bug fixes (Scroll, Images, AspectRatio)](#14-inline-onclick-scroll-handlers-are-fragile) | S      | Low    |
| [x]  | P3       | [10.x Code quality items](#10-code-quality--best-practices)                                                 | S      | Low    |
| [x]  | P1       | [5.1 Listing page hero banner](#51-add-a-hero-banner-to-listing-pages)                                      | M      | High   |
...
| [x]  | P3       | [6.1 Tag landing pages](#61-create-tag-landing-pages-tags-tag)                                              | L      | High   |
| [x]  | P3       | [6.2 Category landing pages](#62-create-category-landing-pages-categories-category)                         | L      | High   |
