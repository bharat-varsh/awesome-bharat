(() => {
    ...
    function ce(l, e) {
        return l === e
            ? !0
            : (gt || (gt = document.createElement('a')), (gt.href = e), l === gt.href);
    }
    function Hl(l) {
        return Object.keys(l).length === 0;
    }
    var xt = typeof window < 'u' ? window : typeof globalThis < 'u' ? globalThis : global;
    var Ct = class l {
    ...
    function bt(l, e = {}) {
        ...
        if (i > 1 && i < 9) {
            ...
            for (
                ...
                for (
                    ;
                    a.charCodeAt(n) === 45 && P(a.charCodeAt(n + 1)) && P(a.charCodeAt(n + 2));
                ) {
                    let C = n + 1;
                    for (n = C + 2, c++; P(a.charCodeAt(n)); ) {
                        if (n - C > 7)
                            return r(n, 2, 'Too long extension, expected at most 8 characters');
                        n++;
                    }
                }
                if (!c)
        ...
        if (
            ...
            for (; a.charCodeAt(n) === 45 && P(a.charCodeAt(n + 1)); ) {
                ...
                for (n = c; P(a.charCodeAt(n)); ) {
                    if (n - c > 7)
                        return r(n, 5, 'Too long private-use area, expected at most 8 characters');
                    n++;
                }
    ...
    function Aa(l, e, t) {
        let { show_images: s = !0 } = e,
            ...
            c = [],
            C = (o, d) => {
                if (!o || /^[a-z][a-z0-9+.-]*:/i.test(o) || /^\/\//.test(o) || o.startsWith('/'))
                    return o;
                try {
    ...
    function Qs(l) {
        ...
        return {
            ...
            p(c, C) {
                if (
                    (C & 112 && s !== (s = c[4]('filters_label', c[5], c[6]) + '') && H(a, s),
                    C & 143)
                ) {
        ...
        return {
            ...
            p(s, a) {
                a[0] & 589952 &&
                    e !==
                        (e =
                            s[20]('zero_results', s[19], s[7]).replace(/\[SEARCH_TERM\]/, s[16]) +
                            '') &&
                    H(t, e);
            },
            d(s) {
        ...
        return {
            ...
            p(a, i) {
                i[0] & 589952 &&
                    t !==
                        (t =
                            a[20]('searching', a[19], a[7]).replace(/\[SEARCH_TERM\]/, a[16]) +
                            '') &&
                    H(s, t);
            },
            d(a) {
