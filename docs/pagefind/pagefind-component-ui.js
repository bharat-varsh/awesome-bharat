    ...
    function ze(n, s = {}) {
        ...
        if (i > 1 && i < 9) {
            ...
            for (
                ...
                for (
                    ;
                    r.charCodeAt(l) === 45 && k(r.charCodeAt(l + 1)) && k(r.charCodeAt(l + 2));
                ) {
                    let c = l + 1;
                    for (l = c + 2, o++; k(r.charCodeAt(l)); ) {
                        if (l - c > 7)
                            return a(l, 2, 'Too long extension, expected at most 8 characters');
                        l++;
                    }
                }
                if (!o)
        ...
        if (
            ...
            for (; r.charCodeAt(l) === 45 && k(r.charCodeAt(l + 1)); ) {
                ...
                for (l = o; k(r.charCodeAt(l)); ) {
                    if (l - o > 7)
                        return a(l, 5, 'Too long private-use area, expected at most 8 characters');
                    l++;
                }
    ...
    var ye = (n) =>
        ...
        es = {
            ...
            safeUrl: (n, ...s) => {
                ...
                return e && /^(?:\.{0,2}\/|[#?]|(?:https?|ftp):\/\/|(?:mailto|tel):)/i.test(e)
                    ? e
                    : '';
            },
        },
            ...
            for (let [e, t] of this.filterElements) {
                ...
                (t.label.toggleAttribute('data-pf-hidden', !d),
                    d && _
                        ...
                        : !d &&
                          !_ &&
                          this.groupVisibleCounts.set(i, (this.groupVisibleCounts.get(i) ?? 1) - 1),
...
{{/each}}
  ...
  <p class="pf-searchbox-result-excerpt pf-skeleton pf-skeleton-excerpt"></p>
        ...
        Fe = class extends f {
            ...
            get placeholder() {
                return (
                    this._userPlaceholder || this.instance?.translate('placeholder') || 'Search...'
                );
            }
            readAttributes() {
                (this.hasAttribute('placeholder') &&
